...
// retourne si la civilisation peut faire la recherche 'recherche'
var
  rech: string; // boolean indiquant si la recherceh est possible
begin
  ...
  begin
    // si les prerequis sont verifiés
...
begin
  ...
  c.recherches[n].description := 'Vos soldats seront equipés de meilleures armes et armure';
